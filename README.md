...
Participação (%) de cada tipo de venda
→ (Venda de produtos, equipamentos e serviços / Receita Bruta) × 100.

Crescimento mensal da Receita Total
...
Gráfico de linha com evolução mensal da receita total.
...
Script SQL utilizado para gerar o resultado.

Base de dados exportada (planilha com o resultado consolidado).

Painel montado (Power BI / Excel / Data Studio).

Resumo com principais insights e observações.
